...
Each member contributed to the same project document (ProjectReport.docx) through individual branches to simulate a real-world software development workflow.
This repository serves as a practical example of how GitHub supports collaborative software development, version tracking, and conflict resolution.
